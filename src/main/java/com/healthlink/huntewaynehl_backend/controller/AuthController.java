...
//
//    @PostMapping("/signup")
//    public <UserDTO> String signup(@RequestBody UserDTO user) {
//        // Logic to save user (e.g., save to DB)
//        return "Signup successful";  // This message will be received in the frontend
//    }
//}
